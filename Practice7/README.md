...
1.Использовать разделяемую память внутри блока, чтобы потоки быстро обменивались данными.

2.Делить массив на блоки и делать сканирование сначала внутри блоков, а потом объединять результаты блоков.

3. Сократить количество синхронизаций потоков, чтобы они меньше ждали друг друга.
